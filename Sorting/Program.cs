namespace Sorting
{
    internal class Program
    {
        ...
        static void MergeSort(int[] array, int start, int end)
        {
            ...
            MergeSoretdIntervals(array, start, middle, middle + 1, end);
        }

        static void MergeSoretdIntervals(int[] array, int start1, int end1, int start2, int end2)
        {
            if (start1 > end1) throw new InvalidOperationException("End cannot be lower than Start (section1)");
            if (start2 > end2) throw new InvalidOperationException("End cannot be lower than Start (section2)");
